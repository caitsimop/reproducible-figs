...
%      \begin{figure}
      ...
      \vspace{.5cm}
          ...
          {\normalsize January 22, 2020 \\ Caitlin Simopoulos }
...
\item It saves \alert{you} time in the long run
    \bi
        \item Small OR big changes to figures are less painful
        \item Can create automated pipeline for new data! %``Easy'' to do the same analysis on different data
    \ei
